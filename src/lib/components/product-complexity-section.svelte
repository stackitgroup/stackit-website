...
<section class="pt-20 md:py-32 bg-black min-h-dvh flex items-center">
  <div class="container mx-auto px-6">
    <div
      class="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-16 md:items-start"
    >
      <div
      ...
      <div
        class="order-first md:order-1 fade-in-section text-center md:text-left"
      >
        <h2
          class="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight text-center md:text-left"
        >
          We know that creating a great product is complicated
        </h2>
        <div
          class="text-left fade-in-section mt-16 md:inline-block hidden"
        >
          <a
            href="#contact"
    ...
    <div class="mt-12 md:mt-20 fade-in-section">
      ...
      <div
        class="hidden md:flex flex-wrap items-center justify-center gap-x-16 gap-y-8 mt-20"
      >
        <img
          src={siemensLogo}
          alt="Siemens Logo"
