		...
		<div class="grid items-start gap-12 lg:grid-cols-3">
			<div class="lg:col-span-1 lg:sticky top-28">
				...
				<div class="hidden mt-8 lg:block fade-in-section">
					<a
						href="#contact"
						class="bg-[#3F5FDD] mr-2 text-white whitespace-nowrap font-semibold px-12 py-4 text-lg sm:px-22 sm:py-6 sm:text-xl hover:bg-[#3550B8] transition-colors duration-300 inline-block rounded-lg"
					>Introduction Call</a>
				</div>
			</div>
				...
				<div class="flex fade-in-section">
					...
					<div class="pb-12">
						...
						<p class="text-gray-300">
							...
							needs against practical limits like budget and timeline, we
							create a feasible roadmap for your vision.
						</p>
					</div>
				</div>
