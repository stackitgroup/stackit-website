					...
					<div class="flex fade-in-section">
						...
						<div class="pt-1 pb-12">
							...
							<p class="text-gray-300">
								...
								transparent overview of our process, ensuring we both have
								a confident decision on our fit as partners.
							</p>
						</div>
					</div>
					<div class="flex fade-in-section">
						...
						<div class="pt-1 pb-12">
							...
							<p class="text-gray-300">
								We dig deep to get to the heart of your project's 'why'
								and what success truly looks like. By mapping out your
								product needs against practical limits like budget and
								timeline, we create a feasible roadmap for your vision.
							</p>
						</div>
					</div>
					<div class="flex fade-in-section">
						...
						<div class="pt-1 pb-12">
							...
							<p class="text-gray-300">
								...
								outlines the cost, deliverables, timeline, and team
					...
					<div class="flex fade-in-section">
						...
						<div class="pt-1 pb-12">
							...
							<p class="text-gray-300">
								...
								clear collaboration protocol and primes the technical
					...
					<div class="flex fade-in-section">
						...
						<div class="pt-1 pb-12">
							...
							<p class="text-gray-300">
								...
								visible and maintains alignment, culminating in our core
								promise: a demonstration of working software every two
								weeks.
							</p>
						</div>
					</div>
					<div class="flex fade-in-section">
						...
						<div class="pt-1 pb-12">
							...
							<p class="text-gray-300">
								...
								prepare your operational environment and empower your team
								for a seamless, confident go-live.
							</p>
						</div>
					</div>
					<div class="flex fade-in-section">
